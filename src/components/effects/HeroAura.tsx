...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getLocalPosition(clientX: number, clientY: number) {
    ...
    function updateHeroPointer(
      ...
      const position = getLocalPosition(clientX, clientY);
      ...
      const posX = scaleByPixelRatio(position.x);
const posY = scaleByPixelRatio(position.y);
