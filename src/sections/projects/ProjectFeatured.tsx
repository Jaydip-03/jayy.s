    ...
    >
      <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr] lg:items-center lg:gap-10 xl:gap-14">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-center gap-2 text-[11px] font-mono uppercase tracking-[0.2em] text-zinc-500">
            ...
            {project.status && (
              <>
                ...
                <span className="font-medium text-emerald-600">{project.status}</span>
              </>
            )}
            {project.year && (
              <>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-6 border-t border-zinc-200/80 pt-5 text-xs font-medium">
            <Link
              href={`/work/${project.slug}`}
